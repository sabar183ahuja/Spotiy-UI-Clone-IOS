...
//  SpotifyUIClone
//
//  Created by Sabar Ahuja on 2021-07-01.
//
...
struct ContentView: View {
    ...
    var Songs = ["Come Together","Oh! Darling", "Something","Here Comes the Sun"]
            ...
            VStack {
                ...
                VStack{
                    ...
                    VStack(spacing: 24){
                        ...
                        ForEach(0 ..< Songs.count ){
                            Track(name: Songs[$0], artists: artists, explicit: false, playing: $0 == 1 ? true:false)
                        }
